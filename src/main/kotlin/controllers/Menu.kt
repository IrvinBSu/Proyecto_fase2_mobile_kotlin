...
class Menu {
    ...
    companion object {
        ...
        private val menuAvailable: List<FoodItem> = listOf(
            ...
            FoodItem(
                FoodCategory.ARROZ_ORIENTAL,
                "Gohan Furikake",
                "Arroz blanco condimentado con salmón o camarón",
                75.0
            ),
            ...
            FoodItem(
                FoodCategory.ENTRADAS,
                "Tropical",
                "Arandano, nuez mixta, pera, manzana, en combinacion de lechugas con mango",
                125.0
            ),
            ...
            FoodItem(
                FoodCategory.RAMEN,
                "Pork Belly Ramen",
                "Ramen tradicional preparada con consome de cerdo y pollo",
                200.0
            ),
            FoodItem(
                FoodCategory.RAMEN,
                "Pork Miso Ramen",
                "Pasta japonesa preparada en delicioso fondo de miso, shiitake",
                160.0
            ),
            ...
            FoodItem(
                FoodCategory.ESPECIALES,
                "Dragon Roll",
                "Mango y aguacate, camaron empanizado, queso crema",
                130.0
            ),
            ...
            FoodItem(
                FoodCategory.ESPECIALES,
                "Super Tampico",
                "Salsa tampipco, cangrej, queso, chile toreado y kaklague",
                125.0
            ),
